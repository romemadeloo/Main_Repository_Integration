...
//         <svg xmlns="http://www.w3.org/2000/svg" width="30" margin-top="40" height="30" fill="currentColor" className="bi bi-eye-fill" viewBox="0 0 16 16">
//           <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0"/>
//           <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/>
//         </svg>
//         <h1>Vision</h1>
//         <p className="aboutP" style={{ padding: '.5rem', width: '50%' }}>
//           TGSI is committed to be THE PREMIER GLOBAL I.T. BUSINESS PARTNER driven by passion for innovation.
//         </p>
//       </div>
//       <div className="photo-box">
...
//           for the welfare of our COMMUNITY & SOCIETY.
//         </p>
//       </div>
//     </div>
//   );
