...
const VideoLinkModal = () => { // Defining VideoLinkModal functional component
  return (
    <> {/* Fragment shorthand */}
      <div className="w-[100%] h-[100vh] pt-[150px] pb-32 backdrop-blur-[.1rem] "> {/* Main container with styles */}
        <div className=" flex border-[.01rem] drop-shadow-2xl shadow-lg border-black rounded-lg m-auto bg-white lg:max-w-[550px] 2xl:max-h-[672px] 2xl:max-w-[724px] "> {/* Modal container */}
          <form action="" className="w-[80%] m-auto py-2 "> {/* Form container */}
            <div className="flex items-center py-1 text-black lg:font-bold lg:text-3xl lg:py-0"> {/* Title container */}
              <p className=" pb-5 lg:font-bold TeamB_text-shadow lg:text-[1.2rem]  xl:text-[24px] mt-5"> {/* Title */}
                Add Topic Link
              </p>
            </div>
            <input
            ...
            />
            <div className="pt-8 lg:w-full lg:flex lg:justify-end"> {/* Button container */}
              <div className="flex gap-x-5"> {/* Button group */}
