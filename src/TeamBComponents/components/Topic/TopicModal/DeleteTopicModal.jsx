  ...
  return (
    ...
    <>
      <div className=" h-[100vh] pt-[150px] backdrop-blur-[.1rem] ">{/* Main container */}
        <div className=" flex border-[.01rem] drop-shadow-2xl shadow-lg border-black rounded-lg m-auto bg-[#EBFFE5] lg:max-w-[550px]  ">  {/* Modal container */}
          <form action="" className="w-[80%] m-auto ">  {/* Form */}
            <div className="flex items-center py-1 text-black lg:font-bold lg:text-3lg:py-0"> {/* Title container */}
              <p className="  lg:font-bold TeamB_text-shadow lg:text-[1.2rem]   pt-2">{/* Title */}
                Topic Title
              </p>
            </div>
            <p className=" pb-2 lg:font-bold TeamB_text-shadow lg:text-[1.2rem]   pt-2"> {/* Confirmation message */}
