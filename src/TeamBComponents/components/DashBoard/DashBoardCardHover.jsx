          ...
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <div className="p-10">
              <p className="bg-[#87D275] p-5 rounded-lg text-justify">
                ...
                websites. It includes aspects such as web design, web
                publishing, web programming, and database management. Web
                development can range from developing a simple single static
                page of plain text to complex web applications, electronic
                businesses, and social network services. It mainly deals with
                the non-design aspect of building websites, which includes
                coding and writing markup.
                <p className="pt-3">With 3 Chapters and 2 topic each</p>
                <p className="pt-2">Get a certificate for passing the course by passing 80% of quiz and assessment</p>
              </p>
            </div>
          </div>
        </div>
