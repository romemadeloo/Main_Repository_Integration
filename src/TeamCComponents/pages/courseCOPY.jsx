        ...
        <Fragment>
            ...
            <div className="container mt-5">
                <div className="card text-center">
                    <div className="c_course_header card-header">
                    ...
                    {/* C LANGUAGE */}
                    <div className="c_course_cardbody card-body tab-content">
                        ...
                        {/* HTML */}
                        <div className="c_course_cardbody tab-pane fade" id="svn">
                        ...
                        {/* SUBVERSION */}
                        <div className="c_course_cardbody tab-pane fade" id="hprog">
