...
import "../../TeamCComponents/css/chapterlist.css";
...
function ChapterList() {
    ...
    return (
        <>
            <Team_D_HeaderV2 />
            {/* Back button */}
            <Link onClick={() => navigate(-1)} className="buttonReturn d-flex align-items-center c_chapter_rtrncontainer" style={{ textDecoration: 'none', color: 'black', width: 'fit-content', }}>
                <div>
            ...
            <div className="container mt-4 mx-auto">
                {chapters.map((chap, idx) => {
                    ...
                    return (
                        <div key={idx}>
                            <h2 className="c_crs_ttl text-left mb-4" style={{ fontWeight: 'bold', fontSize: '2rem' }}>{course_title}</h2><hr />
                            {chapter && chapter.map((chap, idc) => {
                                ...
                                return (
                                    <div className="d-flex align-items-center" key={idc}>
                                        <div className="c_chapter_cardmain card flex-grow-1" style={{
                                            ...
                                            <Link to={`/api/v1/auth/topics/${chapter_id}`} className="h5 text-white text-decoration-none c_chapter_cardtext">
